...
<style>
#observe-resize div.centered {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
  }
#observe-resize figure {
    width: 390px;
    margin: 1rem;
  }
#observe-resize img {
...
#observe-resize #pictures {
    display: flex;
    flex-wrap: wrap;
    justify-content: center;
  }
#observe-resize #alice-fraser {
    text-align: center;
  }
#observe-resize #alice-fraser img {
    max-width: 600px;
  }
#observe-resize #alice-fraser p:last-of-type {
    text-align: left;
  }
#observe-resize #alice-fraser p:first-of-type {
    margin-top: 0;
  }
#observe-resize #alice-fraser h3 {
    margin-bottom: 0;
  }
</style>
