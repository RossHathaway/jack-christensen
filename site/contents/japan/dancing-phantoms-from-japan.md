...
#observe-resize h2 > span {
    grid-column-start: 2;
  }
#observe-resize img {
    margin: 0.25rem;
  }
#observe-resize img.header {
    max-height: 70px;
  }
...
#observe-resize #pictures-section-1 {
    position: relative;
    left: -100px;
    width: calc(100% + 200px);
    display: flex;
  }
#observe-resize #pictures-section-1 div {
    height: 880px;
    display: flex;
...
#observe-resize #pictures-section-1 > div:first-of-type {
      align-items: flex-end;
  }
#observe-resize #pictures-section-1 > div:last-of-type {
...
#observe-resize #pictures-section-2 {
    display: flex;
    flex-wrap: wrap;
