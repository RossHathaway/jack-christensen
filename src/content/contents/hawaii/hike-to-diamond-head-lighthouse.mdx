...
description: The history of the Hike to Diamond Head Lighthouse through Kapiʻolani Park - the 50th State’s oldest all-volunteer litter control project, running since 1982.

---
import './hike-to-diamond-head-lighthouse.css';
...
import imgArmyVolunteersAtDiamondHead from '../../../assets/diamond-head/army-volunteers-at-diamond-head.png';
import imgNavyBringingTrashCan from '../../../assets/diamond-head/navy-bringing-trash-can.png';
import imgScrapMetalOnCraterFloor from '../../../assets/diamond-head/scrap-metal-on-crater-floor.png';
import imgTrashUtilityPolesAndCables from '../../../assets/diamond-head/trash-utility-poles-and-cables.png';
import imgLumberAndTrashBags from '../../../assets/diamond-head/lumber-and-trash-bags.png';
import imgCentralDumpSite from '../../../assets/diamond-head/central-dump-site.png';
import imgAliceFraser from '../../../assets/diamond-head/alice-fraser.png';
...
<section id="pictures">
<figure>
<Image src={imgArmyVolunteersAtDiamondHead} alt="Army volunteers prepare to rappel down to remove litter" width={736} densities={[1, 2]} />
<figcaption>
...
<figure>
<Image src={imgNavyBringingTrashCan} alt="Navy bringing trash can to Diamond Head" width={736} densities={[1, 2]} />
<figcaption>
...
<figure>
<Image src={imgScrapMetalOnCraterFloor} alt="Abandoned car bodies and scrap metal heaped on the crater floor of Diamond Head" width={736} densities={[1, 2]} />
<figcaption>
...
<figure>
<Image src={imgTrashUtilityPolesAndCables} alt="rusted cables and fallen utility poles await removal" width={736} densities={[1, 2]} />
<figcaption>
...
<figure>
<Image src={imgLumberAndTrashBags} alt="Stacked lumber and bagged junk collected from alongside the trail." width={736} densities={[1, 2]} />
<figcaption>
...
<figure>
<Image src={imgCentralDumpSite} alt="central dump site" width={736} densities={[1, 2]} />
<figcaption>
...
A Continuing Tribute To The Memory Of Alice Fraser
 ...
 <Image src={imgAliceFraser} alt="Alice Fraser, a member of the Clean Air Team" width={736} densities={[1, 2]} />
