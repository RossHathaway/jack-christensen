...
<section id="pictures">
<figure>
<Image src={imgArmyVolunteersAtDiamondHead} alt="Army volunteers prepare to rappel down to remove litter" />
<figcaption>
...
<figure>
<Image src={imgNavyBringingTrashCan} alt="Navy bringing trash can to Diamond Head" />
<figcaption>
...
<figure>
<Image src={imgScrapMetalOnCraterFloor} alt="Abandoned car bodies and scrap metal heaped on the crater floor of Diamond Head" />
<figcaption>
...
<figure>
<Image src={imgTrashUtilityPolesAndCables} alt="rusted cables and fallen utility poles await removal" />
<figcaption>
...
<figure>
<Image src={imgLumberAndTrashBags} alt="Stacked lumber and bagged junk collected from alongside the trail." />
<figcaption>
...
<figure>
<Image src={imgCentralDumpSite} alt="central dump site" />
<figcaption>
...
A Continuing Tribute To The Memory Of Alice Fraser
 ...
 <Image src={imgAliceFraser} alt="Alice Fraser, a member of the Clean Air Team" />
