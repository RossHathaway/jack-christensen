---
tags: [japan]
title: Dancing Phantoms From Japan
description: An introduction to the classical Noh dance-drama of Japan presented by Uncle Jack, with looks behind-the-scenes and examples of famous Noh performances.
---
import './dancing-phantoms-from-japan.css';
import { Image } from 'astro:assets';
import imgDancingPhantomsFromJapan2 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-2.png';
import imgDancingPhantomsFromJapan1 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-1.png';
import imgDancingPhantomsFromJapanEdited from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-edited.png';
import imgDancingPhantomsFromJapan4 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-4.png';
import imgDancingPhantomsFromJapan5 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-5.png';
import imgDancingPhantomsFromJapan6 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-6.png';
import imgDancingPhantomsFromJapan7 from '../../../assets/dancing-phantoms/dancing-phantoms-from-japan-7.png';

<main>

<h2>
  <img src="dancing-phantoms/DancingPhantomsFromJapanIcon.svg" alt="Japanese Character" class="header" width="64" height="70" />
...
<div>
<Image src={imgDancingPhantomsFromJapan2} alt="Noh performer with mask" width={936} densities={[1, 2]} />
<Image src={imgDancingPhantomsFromJapan1} alt="Noh performers getting ready" width={936} densities={[1, 2]} />
</div>

<div>
<Image src={imgDancingPhantomsFromJapanEdited} alt="Noh performer on stage" width={936} densities={[1, 2]} />
<Image src={imgDancingPhantomsFromJapan4} alt="photographer taking a picture of the costume area" width={936} densities={[1, 2]} />
</div>
...
<Image src={imgDancingPhantomsFromJapan5} alt="Noh performer getting dressed" width={936} densities={[1, 2]} />
<Image src={imgDancingPhantomsFromJapan6} alt="Noh performer in costume" width={936} densities={[1, 2]} />
<Image src={imgDancingPhantomsFromJapan7} alt="speaker informing audience in Noh performance" width={936} densities={[1, 2]} />
