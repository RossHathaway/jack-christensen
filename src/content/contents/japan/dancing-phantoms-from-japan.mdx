...
<div>
<Image src={imgDancingPhantomsFromJapan2} alt="Noh performer with mask" />
<Image src={imgDancingPhantomsFromJapan1} alt="Noh performers getting ready" />
</div>

<div>
<Image src={imgDancingPhantomsFromJapanEdited} alt="Noh performer on stage" />
<Image src={imgDancingPhantomsFromJapan4} alt="photographer taking a picture of the costume area" />
</div>
...
<Image src={imgDancingPhantomsFromJapan5} alt="Noh performer getting dressed" />
<Image src={imgDancingPhantomsFromJapan6} alt="Noh performer in costume" />
<Image src={imgDancingPhantomsFromJapan7} alt="speaker informing audience in Noh performance" />
