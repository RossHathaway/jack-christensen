...
<Image src={imgGhandi1} alt="Ben Kingsley and Candice Bergen in Mahatma Gandhi movie" id="gandhi-1" />
</div>
...
<Image src={imgGhandi2} alt="Attenborough directs a scene with Kingsley and front line extras" id="gandhi-2" />
